...
const std::map<std::filesystem::path, std::filesystem::path> PkgBuilder::cpp_rename = {
    ...
    {"bits/ranges_uninitialized.h", "ranges_uninitialized.h2"},
    {"bits/ranges_util.h", "ranges_util.h3"},
    ...
    {"bits/uses_allocator.h", "uses_allocator.h2"},
    {"bits/uses_allocator_args.h", "uses_allocator_args.h3"},
    ...
    {"experimental/bits/simd_x86.h", "simd_x86.h2"},
    {"experimental/bits/simd_x86_conversions.h", "simd_x86_conversions.h3"},
